import agg/[comp_op, pixfmt_rgba, pixfmt_gray, pixfmt_rgb,
  color_rgba, color_gray, rendering_buffer, gamma_lut]
...
type
  ...
  pixfmt = distinct pointer
  GammaLUT8 = distinct pointer

proc create_rbuf(buffer: cstring, frameWidth, frameHeight, stride: cint): rbuf {.importc.}
proc create_pixf(rbuf: rbuf): pixfmt {.importc.}
proc blend_pixel(pixf: pixfmt, x, y: cint, c: var Rgba8, cover: uint8) {.importc: "pixf_blend_pixel".}
proc blend_color_hspan(pixf: pixfmt, x, y: cint, len: cuint, colors: ptr Rgba8, covers: ptr uint8, cover: uint8) {.importc: "pixf_blend_color_hspan".}
proc blend_color_vspan(pixf: pixfmt, x, y: cint, len: cuint, colors: ptr Rgba8, covers: ptr uint8, cover: uint8) {.importc: "pixf_blend_color_vspan".}
proc blend_hline(pixf: pixfmt, x, y: cint, len: cuint, c: var Rgba8, cover: uint8) {.importc: "pixf_blend_hline".}
proc blend_vline(pixf: pixfmt, x, y: cint, len: cuint, c: var Rgba8, cover: uint8) {.importc: "pixf_blend_vline".}
proc blend_solid_hspan(pixf: pixfmt, x, y: cint, len: cuint, c: var Rgba8, covers: ptr uint8) {.importc: "pixf_blend_solid_hspan".}
proc blend_solid_vspan(pixf: pixfmt, x, y: cint, len: cuint, c: var Rgba8, covers: ptr uint8) {.importc: "pixf_blend_solid_vspan".}
proc apply_gamma_inv(pixf: pixfmt, g: GammaLUT8) {.importc: "pixf_apply_gamma_inv".}
proc apply_gamma_dir(pixf: pixfmt, g: GammaLUT8) {.importc: "pixf_apply_gamma_dir".}
proc create_gamma_lut8(): GammaLUT8 {.importc.}
proc copy_pixel(pixf: pixfmt, x, y: cint, c: var Rgba8) {.importc: "pixf_copy_pixel".}
proc pixel(pixf: pixfmt, x, y: cint): Rgba8 {.importc: "pixf_pixel".}
proc copy_vline(pixf: pixfmt, x, y: cint, len: cuint, c: var Rgba8) {.importc: "pixf_copy_vline".}
proc copy_hline(pixf: pixfmt, x, y: cint, len: cuint, c: var Rgba8) {.importc: "pixf_copy_hline".}
proc copy_color_hspan(pixf: pixfmt, x, y: cint, len: cuint, c: ptr Rgba8) {.importc: "pixf_copy_color_hspan".}
proc copy_color_vspan(pixf: pixfmt, x, y: cint, len: cuint, c: ptr Rgba8) {.importc: "pixf_copy_color_vspan".}
