...
proc onDraw() =
  ...
  path.drawPath(ras, ren, sl, Color(0x221BE2))
  ...
  path.drawPath(ras, ren, sl, Color(0x526EEB))
  ...
  path.closePolygon()
  path.drawPath(ras, ren, sl, colWheat)
  ...
  path.drawPath(ras, ren, sl, Color(0xA1B5F3))
  ...
  path.drawPath(ras, ren, sl, Color(0x241dE4))
  ...
  path.drawPath(ras, ren, sl, Color(0x5271EB))
