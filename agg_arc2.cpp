...
namespace agg
{
                   ...
                   bool ccw)
    {
        ...
        /*printf("x:%3.3f y:%3.3f rx:%3.3f ry:%3.3f ", m_x, m_y, m_rx, m_ry);
        printf("a:%3.3f s:%3.3f e:%3.3f s:%3.3f ", m_angle, m_start, m_end, m_scale);
        printf("da:%3.3f ccw:%d init:%d cmd:%d\n", m_da, m_ccw, m_initialized, m_path_cmd);*/
        /*double   m_x;
        double   m_y;
        double   m_rx;
        double   m_ry;
