...
import agg_conv_bspline, agg_conv_segmentator, agg_font_freetype, agg_font_cache_manager
...
import agg_platform_support, random, os, agg_trans_affine
...
proc main(): int =
  ...
  if app.init(frameWidth, frameHeight, {}, "trans_curve1_ft"):
    return app.run()
