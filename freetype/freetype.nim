...
proc FT_New_Memory_Face*(library: FT_Library; file_base: ptr FT_Byte;
                        file_size: FT_Long; face_index: FT_Long; aface: var FT_Face): FT_Error {.ft_import.}
proc FT_Open_Face*(library: FT_Library; args: ptr FT_Open_Args; face_index: FT_Long;
                  aface: ptr FT_Face): FT_Error {.ft_import.}
proc FT_Attach_File*(face: FT_Face; filepathname: cstring): FT_Error {.ft_import.}
proc FT_Attach_Stream*(face: FT_Face; parameters: ptr FT_Open_Args): FT_Error {.ft_import.}
...
type
  ...
  FT_Size_Request* = ptr FT_Size_RequestRec

proc FT_Request_Size*(face: FT_Face; req: FT_Size_Request): FT_Error {.ft_import.}
proc FT_Set_Char_Size*(face: FT_Face; char_width: FT_F26Dot6;
                      char_height: FT_F26Dot6; horz_resolution: FT_UInt;
                      vert_resolution: FT_UInt): FT_Error {.ft_import.}
...
proc FT_Set_Transform*(face: FT_Face; matrix: ptr FT_Matrix; delta: ptr FT_Vector) {.ft_import.}
...
proc FT_Get_Track_Kerning*(face: FT_Face; point_size: FT_Fixed; degree: FT_Int;
                          akerning: ptr FT_Fixed): FT_Error {.ft_import.}
...
proc FT_Get_First_Char*(face: FT_Face; agindex: ptr FT_UInt): FT_ULong {.ft_import.}
proc FT_Get_Next_Char*(face: FT_Face; char_code: FT_ULong; agindex: ptr FT_UInt): FT_ULong {.ft_import.}
proc FT_Get_Name_Index*(face: FT_Face; glyph_name: ptr FT_String): FT_UInt {.ft_import.}
...
proc FT_Get_SubGlyph_Info*(glyph: FT_GlyphSlot; sub_index: FT_UInt;
                          p_index: ptr FT_Int; p_flags: ptr FT_UInt;
                          p_arg1: ptr FT_Int; p_arg2: ptr FT_Int;
                          p_transform: ptr FT_Matrix): FT_Error {.ft_import.}
const
...
proc FT_Vector_Transform*(vec: ptr FT_Vector; matrix: ptr FT_Matrix) {.ft_import.}
